...
public class Main extends SimpleApplication
    ...
    public void simpleInitApp() {
        ...
        Spatial sceneModel = assetManager.loadModel("Models/MONTE+ALBAN+PIRAMIDS/MONTE+ALBAN+PIRAMIDS.obj");
   ...
   private void setUpLight() {
        ...
        Vector3f northDirection = new Vector3f(0f, -1f, 0f); // Pointing south (opposite to north)
        Vector3f southDirection = new Vector3f(0f, 1f, 0f);  // Pointing north
        Vector3f eastDirection = new Vector3f(-1f, 0f, 0f);  // Pointing west (opposite to east)
